...
Rating key:
- **S** = Must-pick in almost any build
- **A** = Strong pick, core in at least one archetype
- **B** = Good situational pick
- **C** = Filler, take if nothing better
- **D** = Generally avoid
...
- **Synergies**: Any Aquatic board, late-game finisher
...
- **Synergies**: Haste sources, Port (reload), Javelin alternative
...
- **Synergies**: Shipwreck (permanent Haste loop), Pufferfish, non-Weapon boards
...
- **Synergies**: Tool/Aquatic-heavy boards
...
- **Synergies**: Shuriken, Dive Weights, any fast adjacent item, Gunslinger builds
...
- **Synergies**: Lighter, Incendiary Rounds, Burn builds
...
- **Synergies**: Flagship, Submarine, Tortuga, any Vehicle/Large item
...
- **Synergies**: Crit stacking, Crow's Nest, Silencer, Swash Buckle
...
- **Synergies**: Dock Lines, Shot Glasses, Clamera, Slow triggers, Lighthouse
...
- **Synergies**: Depends entirely on what you get
...
- **Synergies**: Shipwreck (expands Multicast targets), Figurehead, Sea Shell
...
- **Synergies**: Darkwater Anglerfish, Lighthouse, Mantis Shrimp, Iceberg
...
- **Synergies**: Powder Flask, Cannonball, Ammo builds, Crit stacking
...
- **Synergies**: Weather Glass, Aquatic boards, Slumbering Primordial
...
- **Synergies**: Tortuga (most Friends are Aquatic), any Aquatic engine, single right weapon
...
- **Synergies**: Slow triggers, free board filler
...
- **Synergies**: Control strategies, slow matchups
...
- **Synergies**: Haste sources, Beach Ball, Astrolabe
...
- **Synergies**: Sharkclaws (classic opener), damage buffs, trigger-based boards, Bladed Hoverboard
...
- **Synergies**: Aggressive builds that win early
...
- **Synergies**: Any build as defensive insurance
...
- **Synergies**: Weapon builds, winning streaks
...
- **Synergies**: Weapon builds, Gold generation, must activate before multicast items
...
- **Synergies**: Tortuga (more Friend triggers), Seadog's Saloon
...
- **Synergies**: Ammo-heavy boards, Gunslinger builds, Dive Weights
...
- **Synergies**: Burn sources for fast charging, finisher item
...
- **Synergies**: Jellyfish (Day 1 combo), Astrolabe, Beach Ball, Shipwreck, any Haste source
...
- **Synergies**: Ammo builds, Double Barrel, Revolver
...
- **Synergies**: Multiple Ammo items, Port
...
- **Synergies**: Single-weapon builds, Silencer, passive weapons only
...
- **Synergies**: Any build with type diversity, Orange Julian (ensure it triggers first), small-item-heavy boards
...
- **Synergies**: Any build, especially slow cooldown items, Tortuga (Friend)
...
- **Synergies**: Crit builds, Pufferfish (Haste triggers from Crits)
...
- **Synergies**: Haste builds, Tortuga (Friend trigger), IllusoRay (Ray adjacency)
...
- **Synergies**: Board expansion, any build wanting more items
...
- **Synergies**: Silencer, Custom Scope, single-weapon builds
...
- **Synergies**: Crit builds, any adjacent item that benefits from Crit
...
- **Synergies**: Any build, especially items that benefit from both Crit and speed
...
- **Synergies**: Captain's Wheel, Vehicle builds
...
- **Synergies**: High Crit boards, adjacent to key items
...
- **Synergies**: Submarine, Flagship, Aquatic boards, any Large item
...
- **Synergies**: Any build (passive), Fiery enchant for Burn, Slow triggers
...
- **Synergies**: Sea Shell, Pearl, Coral Armor, defensive Aquatic builds
...
- **Synergies**: Burn builds, Zoarcid charging, Blunderbuss, Musket reload
...
- **Synergies**: Lighter, Volcanic Vents, Dock Lines, Clamera, any debuff item counts toward Multicast
