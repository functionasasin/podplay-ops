...
- **Synergies**: Ammo-heavy boards, Port (reload), Dive Weights, Torpedo
...
- **Synergies**: Multi-weapon boards, fast weapons like Katana for charging
...
- **Synergies**: Vehicle builds, Tool-heavy boards, Ammo items, single weapon
...
- **Synergies**: Economy builds, Ambergris (Value scaling), long-game strategies
...
- **Synergies**: Sniper Rifle, Cutlass, any single-weapon strategy, Crit stacking
...
- **Synergies**: Aquatic-heavy boards for fast charging
...
- **Synergies**: Tool, Property, Friend, Ammo items (all count), Captain's Wheel, diverse boards
...
- **Synergies**: Any build (passive), Slumbering Primordial, Yeti Crab
...
- **Synergies**: Dock Lines, Shot Glasses, Clamera, Darkwater Anglerfish, any Slow trigger
...
- **Synergies**: Ammo-heavy boards, Ballista, Double Barrel, any Ammo weapon
...
- **Synergies**: Friend-heavy boards, Pufferfish (Haste trigger), Darkwater Anglerfish (Slow trigger)
...
- **Synergies**: Incendiary Rounds (highest trigger count), Dive Weights, Holsters + Heated Shells combo, Lighter, Pop Snappers, Nesting Doll
...
- **Synergies**: Figurehead (most Friends are Aquatic), IllusoRay (triple charge), Orange Julian, Zoarcid, Pufferfish + Jellyfish
...
- **Synergies**: Weapons for charging, Haste sources, Water Wheel, Burn builds
...
- **Synergies**: Slow-heavy boards, sustain strategies
...
- **Synergies**: Trebuchet, Pufferfish, any Haste-dependent build, adjacent fast items
