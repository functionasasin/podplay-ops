...
- **Synergies**: Any Aquatic build, Cove (Value scaling)
...
- **Synergies**: Any weapon to its right, especially fast weapons like Katana
...
- **Synergies**: Poison builds, Weather Glass
...
- **Synergies**: Slow triggers (Darkwater Anglerfish, Lighthouse), Ammo support
...
- **Synergies**: Weapon damage buffs, Crit items
...
- **Synergies**: Weapon builds, Crit stacking, Friend triggers (Tortuga)
...
- **Synergies**: Double Barrel, Revolver, any Ammo weapon
...
- **Synergies**: Shipwreck (Aquatic Multicast), Beach Ball, Astrolabe, any Haste source
...
- **Synergies**: Aquatic-heavy boards, Piranha
...
- **Synergies**: Zoarcid (immediate trigger), Slow triggers, any build
...
- **Synergies**: Economy builds, Orange Julian
...
- **Synergies**: Aquatic builds, sustain strategies
...
- **Synergies**: Slumbering Primordial, Gunslinger builds, Ammo support (Powder Flask, Cannonball)
...
- **Synergies**: Powder Flask, Port, Crit builds
...
- **Synergies**: Multi-weapon builds, Sharkclaws stacking
...
- **Synergies**: Small-item-heavy boards, Slumbering Primordial, fast startup strategies
...
- **Synergies**: Single strong weapon (Cutlass, Sniper Rifle), positioned left of main weapon
...
- **Synergies**: Yeti Crab, Slumbering Primordial, Freeze/control builds
...
- **Synergies**: Slumbering Primordial, Burn builds, Ammo items
...
- **Synergies**: Pufferfish (classic combo), Shipwreck, Beach Ball, any Aquatic
...
- **Synergies**: Slow triggers, Lighthouse
...
- **Synergies**: Burn builds, Blunderbuss charging, Zoarcid, Slumbering Primordial, Musket reload
...
- **Synergies**: Dock Lines, Clamera, Slow triggers, Burn builds
...
- **Synergies**: Haste/Slow builds, Friend triggers (Tortuga)
...
- **Synergies**: Zoarcid (fast charging), Slumbering Primordial, Ammo builds, Dive Weights
...
- **Synergies**: Tortuga, Electric Eels variant, Haste/Slow builds
...
- **Synergies**: Any Aquatic build, Pufferfish triggers, Haste chains
...
- **Synergies**: Friend-heavy boards, Burn builds, Properties
...
- **Synergies**: Solo-Friend weapon builds
...
- **Synergies**: Powder Horn (reload), Burn builds, Slumbering Primordial triggers
...
- **Synergies**: Double Barrel, Grenade, any Ammo weapon to its right
...
- **Synergies**: Crit stacking, Crow's Nest, Custom Scope
...
- **Synergies**: Aquatic-heavy boards
...
- **Synergies**: Aquatic builds, sustain
...
- **Synergies**: Crit builds, Swash Buckle
...
- **Synergies**: Sniper Rifle, Flagship, Cutlass, any single-weapon strategy
...
- **Synergies**: Multi-weapon boards, Handaxe, Sharkclaws
...
- **Synergies**: Crit builds, Crow's Nest
...
- **Synergies**: Pufferfish/Catfish (adjacent), Slumbering Primordial, Freeze builds
...
- **Synergies**: Tortuga (Friend + Haste), Lighter (Burn charging), Clamera (immediate trigger), Pufferfish
