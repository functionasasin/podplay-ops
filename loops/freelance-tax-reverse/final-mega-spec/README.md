...
**Convergence status:** IN PROGRESS (21/54 aspects analyzed; annual-reconciliation completed)
...
| [domain/lookup-tables/filing-deadlines.md](domain/lookup-tables/filing-deadlines.md) | COMPLETE | 9-part reference: quarterly 1701Q deadlines (Q1 May 15 / Q2 Aug 15 / Q3 Nov 15 / Annual Apr 15) with holiday-adjustment pseudocode; concrete adjusted dates for 2024/2025/2026; quarterly 2551Q deadlines (Q1 Apr 25 / Q2 Jul 25 / Q3 Oct 25 / Q4 Jan 25 next year); annual ITR deadlines and installment payment rule; BIR registration and administrative deadlines (Form 1901, 1905, 8% election window table, ARF abolition); SAWT submission and EWT remittance deadlines; complete filing-obligation calendar matrix (10 rows by month for non-VAT graduated filer); days-until-deadline computation function (UpcomingDeadline struct, full pseudocode for all obligations by regime); eFPS group stagger table (groups A–E, non-eFPS note); filing obligation profiles A–E (8% SE, graduated+OSD, graduated+itemized, mixed income 8%, VAT-registered) with per-period form and action rows |
