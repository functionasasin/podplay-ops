...
**Convergence status:** IN PROGRESS (15/53 aspects analyzed; regime-comparison-logic completed)
...
| [domain/edge-cases.md](domain/edge-cases.md) | PARTIAL | EC-T01 through EC-T09 (taxpayer tier edge cases); EC-EM01 through EC-EM07 (e-marketplace RR 16-2023 withholding edge cases); EC-P01 through EC-P07 (penalty/compliance); EC-8-01 through EC-8-11 (8% option edge cases); EC-OSD01 through EC-OSD09 (OSD edge cases); EC-ID01 through EC-ID10 (itemized deduction edge cases); EC-RC01 through EC-RC10 (regime comparison edge cases: ₱0 tax all paths, ₱400K tie Path B=C, OSD-wins window ₱400K–₱437.5K, CWT exceeds annual tax, 40% expense ratio tie A=B, mixed income recommendation, documentation-dependent recommendation switch, single path available, ₱3M threshold boundary, savings display rule); additional groups to be added in Wave 2 edge-cases aspect |
