...
**Convergence status:** IN PROGRESS (24/54 aspects analyzed; bir-form-1701a-field-mapping completed)
...
| [domain/scenarios.md](domain/scenarios.md) | INITIAL COMPLETE | 8 groups, 43+ scenario codes: Group 1 (12 codes, pure service ≤₱3M by income range and method), Group 2 (2 codes, VAT-registered >₱3M), Group 3 (5 codes, mixed income), Group 4 (5 codes, first-year/mid-year: Q1/Q2/Q3/Q4 registration distinguished with exact filing obligations), Group 5 (3 codes, CWT-heavy including platform WI760 withholding), Group 6 (3 codes, threshold crossing with exact mechanics and boundary values), Group 7 (3 codes, special deductions with quantitative notes), **Group 8 NEW (7 quarterly-cycle-specific codes: SC-QC-8-3Q, SC-QC-OSD-3Q, SC-QC-ITEMIZED-3Q, SC-QC-NIL-Q1, SC-QC-CWT-SHIFT, SC-QC-AMENDMENT, SC-QC-OVERPY-Q3)**; priority list of top-10 test scenarios; out-of-scope scenarios reference specific MRF codes |
...
| [domain/manual-review-flags.md](domain/manual-review-flags.md) | PARTIAL | MRF-001 through MRF-024: platform DFSP qualification (MRF-001 to MRF-008); travel expense (MRF-009), home office (MRF-010), dual-use equipment (MRF-011), NOLCO tax-exempt year (MRF-012), capital vs operating loan (MRF-013), bad debt (MRF-014), R&D connection (MRF-015); foreign employer compensation (MRF-016), foreign tax credit (MRF-017), business loss NOLCO tracking (MRF-018); VAT transition quarter OPT/VAT period split (MRF-019); CWT/2307 flags (MRF-020 to MRF-023); **MRF-024 (NEW) cross-year revenue reversal** (prior-year invoice reversed in current year — sales returns exceed current-year gross; engine blocks computation and provides resolution guidance) |
