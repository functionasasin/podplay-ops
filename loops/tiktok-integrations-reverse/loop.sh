#!/bin/bash
# Ralph Loop — TikTok Integration Atlas
# Maps the entire TikTok API/integration landscape and Cheerful applicability.
# Runs Claude Code repeatedly until convergence.
#
# Usage: cd loops/tiktok-integrations-reverse && ./loop.sh [max_iterations]
