...
|-------|-----------------------------------|-------|--------------------------|-------------------------------------------------------|------------|---------|
| 0     | Shared Infrastructure             | —     | —                        | conftest                                              | —          | pending |
| 1     | Security + Bug Fixes              | 7 fix | all specs                | existing\|security                                    | 0          | pending |
| 2     | Campaign CRUD + Launch            | 6     | campaigns.md             | campaign-crud\|launch                                 | 1          | pending |
| 3     | Campaign Recipients + Outbox      | 7     | campaigns.md             | recipients\|outbox\|sender                            | 2          | pending |
...
| 10    | Creator Posts                     | 4     | creators.md              | creator-post                                          | 8          | pending |
