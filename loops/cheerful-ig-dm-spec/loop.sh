#!/bin/bash
# Ralph Loop — Cheerful IG DM Implementation Spec
# Produces exhaustive file-level implementation spec for Instagram DM
# support using Direct Meta API + Parallel Tables architecture.
#
# Usage: cd loops/cheerful-ig-dm-spec && ./loop.sh [max_iterations]
