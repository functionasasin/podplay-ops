#!/bin/bash
# Ralph Loop — SSR Consumer Panel Tools for Decision-Orchestrator
# Specs out MCP tools that let Daimon run simulated consumer panels via SSR methodology.
#
# Usage: cd loops/dec-oc-ssr-tools-reverse && ./loop.sh [max_iterations]
