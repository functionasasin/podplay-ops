#!/bin/bash
# Ralph Loop — Inheritance Premium Forward
# Implements 23 premium features from inheritance-premium-reverse spec.
# Runs Claude Code repeatedly until all 25 stages complete.
#
# Usage: cd loops/inheritance-premium-forward && ./loop.sh [max_iterations]
